    ...
    try {
      ...
      const response = await supabase.functions.invoke("process-transfer", {
        body: {
          ...
          description: formData.description || `Local transfer to ${formData.recipientName}`,
      ...
      toast({
        ...
        description: `Your local transfer of $${amount.toFixed(2)} is pending approval. Ref: ${response.data.reference}`,
      });
      navigate("/dashboard");
      ...
      <div className="p-4">
        ...
        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 mb-4">
          <p className="text-sm text-yellow-600 dark:text-yellow-400">
            ⚠️ Local transfers require admin approval and may take 1-2 business days to process.
          </p>
        </div>
